...
public class SprintActivity extends AppCompatActivity {
    ...
    public class SprintTask extends AsyncTask <Void,Void,List<Sprint>>
    {
        ...
        protected List<Sprint> doInBackground(Void... voids) {
            ...
            SprintList=db.sprintDao().getSprint();
            return SprintList;
        }
        ...
        protected void onPostExecute(List<Sprint> sprints) {
            ...
            for (int i = 0; i < sprintDao.lines(); i++) {
                Log.i("aaaa", "onCreate: db: " + sprintList.get(i).getCity());
            }
            Toast.makeText(getApplicationContext(),String.valueOf(sprintDao.lines()).toString(),Toast.LENGTH_SHORT).show();
        }
    }
}
