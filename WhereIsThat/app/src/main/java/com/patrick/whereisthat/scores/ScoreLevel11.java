...
public class ScoreLevel11 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View ScoreLevel11=inflater.inflate(R.layout.scores_rv,container,false);
        counter++;
        bar=ScoreLevel11.findViewById(R.id.rw_bar);
        if(counter>1)
        {
            bar.setVisibility(View.INVISIBLE);
        }
        mRefreshLayout=ScoreLevel11.findViewById(R.id.swipeRefresh);
        mLayoutManager=new LinearLayoutManager(getContext());
        mRecyclerView=ScoreLevel11.findViewById(R.id.rw_scores);
        ...
        mRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                GetScores.getScoresLevel("level11",mRecylerViewAdapter,mUser);
